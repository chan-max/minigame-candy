...
export class ThreeController {
    ...
    async init() {
        ...
        let model = await loadGltf('src/assets/models/candy.glb')
        this.initModelPosition(model.scene)
        this.scene.add(model.scene)

        // this.scene.add(new Mesh(new BoxGeometry(1, 1, 1), new MeshBasicMaterial({ color: 0xff0000 })))
    }
